 function toolbarClick(args) {
    ...
    {cells: [{colSpan: 4, value: "Reporte de Perifericos Mecanicos", style: {fontColor: '#10437E', fontSize: 15, hAlign: 'Center', bold: true, } }] },
    ]
                },
    footer: {
        footerRows: 2,
    ...
    {
        type: 'Text',
    value: "Reporte de Perifericos Mecanicos",
    position: {x: 0, y: 70 },
    style: {textBrushColor: '#10437E', fontSize: 20, alignment: 'Center' }
                        },
    {
