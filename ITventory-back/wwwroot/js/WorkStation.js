 function toolbarClick(args) {
    ...
    {cells: [{colSpan: 4, value: "Reporte de Estaciones de Trabajo", style: {fontColor: '#10437E', fontSize: 15, hAlign: 'Center', bold: true, } }] },
    ]
                },
    footer: {
        footerRows: 2,
    ...
    {
        type: 'Text',
        value: "Reporte de Estaciones de Trabajo",
    position: {x: 0, y: 70 },
    style: {textBrushColor: '#10437E', fontSize: 20, alignment: 'Center' }
                        },
    {
